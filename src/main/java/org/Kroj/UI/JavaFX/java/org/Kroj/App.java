...
import org.Kroj.UI.Extensions.Server;
import org.Kroj.UI.JavaFX.Controllers.MainController;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            Platform.runLater(Server.instance::start);
